...
public class Program
{
    ...
    private const string DEFAULT_PROJECT_PATH =
        @"C:\DEV\FruVaDEV\FruVa\Web\FruVa.Web\FruVa.Web.csproj";
    ...
    private static void ShowUsageAndExit()
    {
        var usage = $"""
            Usage:
                Publish-FruVaWeb.exe [--Configuration | -c <DEV|PROD>] [--User | -u <username>] [--ProjectDir | -p <path>]
